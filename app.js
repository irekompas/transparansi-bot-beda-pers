...
const rules = [
  ...
  { match: /^alasan_angle$/, q: { id: "Kenapa berita ini penting?", en: "Why it matters" }, k: { id: "kenapa mengapa berita penting alasan angle sudut pandang fokus berita", en: "why story important matters reason angle perspective focus" } },
  ...
  { match: /^relevansi_publik_indonesia$/, q: { id: "Kenapa berita ini penting?", en: "Why it matters" }, k: { id: "kenapa mengapa berita penting publik indonesia relevansi dampak", en: "why story important matters Indonesian public relevance impact" } },
  { match: /^apakah_ai_digunakan/, q: { id: "Apakah AI digunakan dalam penyusunan artikel?", en: "Was AI used in the editorial process?" }, k: { id: "ai kecerdasan buatan transkripsi penggunaan penyusunan artikel", en: "ai artificial intelligence transcription use editorial process" } },
